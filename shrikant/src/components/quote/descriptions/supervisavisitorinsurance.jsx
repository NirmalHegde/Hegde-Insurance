...
const SuperVisaVisitorInsurance = () => {
  return (
    <div>
      <h3>
      ...
      <ul>
        ...
        <li>Expenses related to death from covered medical</li>
      ...
      <ol>
        ...
        <li>Activate once travelling dates confirmed</li>
        <li>Easy claim</li>
      </ol>
    </div>
  );
...
export default SuperVisaVisitorInsurance;
